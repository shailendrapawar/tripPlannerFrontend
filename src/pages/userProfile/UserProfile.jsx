...
const UserProfile = () => {
    ...
    return (
        <div className="userProfile-body h-auto">
            ...
            <section className="h-auto user-data pt-5 pb-5" style={{ backgroundColor: theme.pastel }}>
            ...
            <section className="w-full min-h-100 h-auto">
                <h1 className="text-center pl-5 text-2xl mt-2" style={{ color: theme.dark }}>Your hosted Trips</h1>
