    ...
    <div className="max-w-120 w-[90%] min-h-18 bg-white flex pl-2 gap-2 items-center relative" >
      ...
      <div className="h-15 w-[65%] relative">
        ...
        <div className="relative h-8" style={isApproveRequest ? { display: "block" } : { display: "none" }}>
          <button className="absolute bottom-0 left-20 w-18 text-xs h-6 rounded-sm bg-red-500 text-white" onClick={rejectUser}>REJECT</button>
          <button className="absolute bottom-0 left-0 w-18 text-xs h-6 rounded-sm bg-blue-500 text-white" onClick={approveUser}>APPROVE</button>
        </div>
      </div>
